...
train = pd.read_csv('/Users/pc/PycharmProjects/ML/icr-identify-age-related-conditions/train.csv')
test = pd.read_csv('/Users/pc/PycharmProjects/ML/icr-identify-age-related-conditions/test.csv')
greeks = pd.read_csv('/Users/pc/PycharmProjects/ML/icr-identify-age-related-conditions/greeks.csv')
sample_submission = pd.read_csv('/Users/pc/PycharmProjects/ML/icr-identify-age-related-conditions/sample_submission.csv')
...
x_train,x_test,y_train,y_test = train_test_split(temp_X,temp_Y,test_size=0.3,random_state=30,shuffle=True)
#base line 分类
...
print("Accurcy value:{:.2f} %".format(accuracy_score(y_test,y_pred)))
